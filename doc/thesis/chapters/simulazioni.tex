...
Il veicolo dal quale ha inizio la fase di inoltro (generazione del primo messaggio di Alert) è posizionato
...
\begin{table}[htbp]
	...
	\begin{tabular}{| m{.4\linewidth} | p{.2\linewidth} |}
		...
		Parametro															&			Valore 							\\
		\thickerline
		Lunghezza delle strade [metri] 				&			$4000$							\\
		Distanza fra le strade [metri]				&			$300$								\\
		Distanza fra i veicoloi [metri] 			&			$12$ 								\\
		Raggio trasmissivo effettivo [metri]	&			$300$ - $500$				\\
		Circonferenza [metri]									&			$1000\pm12$					\\
...
%
\subsection{Padova}\label{sec:configurazione-griglia-risultati}
\begin{figure}[htbp]
	\centering
		\includegraphics[width=.49\textwidth]{osm_web-pd-2x2.png}
		\hfill
		\includegraphics[width=.49\textwidth]{osm_web-la-2x2.png}
\caption{.\label{fig:risultati-padova-copertura-tot}}
\end{figure}
