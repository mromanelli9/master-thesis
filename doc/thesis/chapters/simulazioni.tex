...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=.491\textwidth]{osm_web-pd-2x2.png}
		\hfill
		\includegraphics[width=.489\textwidth]{osm_web-la-2x2.png}
...
lungo questo raggio si trovano $50$ veicoli ma, mediamente, nel caso $300$m se ne copre solo il $24,5\%$.
Se ne deduce che alcune caratteristiche intrinseche della città veneta
impattano maggiormente un raggio trasmissivo che uno maggiore rispetto
...
Rimane l'anomalia nel caso \statica{}-$500$m del numero di messaggi di inoltro in \figurename~\ref{fig:risultati-pd-messaggi},
dove si ha un valore inferiore rispetto al protocollo statitico con stima corretta.
...
pari al $44,9\%$, e un aumento con il raggio trasmissivo maggiore, ossia del $46,9\%$,
...
\begin{table}[htbp]
	\centering
	  \begin{tabular}{| L{.4\linewidth} | C{.01\linewidth} | C{.04\linewidth} | C{.2\linewidth} |}
			...
			\multicolumn{3}{|l|}{Distanza fra veicoli [metri]}															&		$25$													\\ \hline
			\multicolumn{3}{|l|}{Numero di veicoli}																					&		$630$													\\ \hline
			\multicolumn{3}{|l|}{Posizione sensori}																					&		incroci												\\ \hline
			\multicolumn{3}{|l|}{Altezza dei sensori [metri]}																&		$6$														\\ \hline
			\multicolumn{3}{|l|}{Numero di sensori}																					&		$120$												\\
			\thickerline
