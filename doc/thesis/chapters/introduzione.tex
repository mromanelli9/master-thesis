...
\begin{itemize}[noitemsep]
	...
	\item Lo studio di un modello per l'ombreggiatura da ostacoli e una sua possibile estensione nello spazio tridimensionale (Capitolo ~\ref{chap:modello-a-ostacoli}).
\end{itemize}
%
\paragraph{}
